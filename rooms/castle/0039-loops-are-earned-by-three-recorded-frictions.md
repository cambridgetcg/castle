...
room: castle
date: 2026-06-10
source: rooms/castle/loops-are-earned-by-three-recorded-frictions.md — laid founding (2026-06-10, generativity judge), promoted L059 (beat castle-C001-20260619-085515)
confidence: tested
front: public
links: 0031, 0032
...
A speculation-free chore list: the Castle is born with four loops and earns every further one when three matching #tags appear across ledger grumbles and by-hand confessions. The grow-loops loop activates the matching dormant recipe, with exactly one new detector block as its bell. The rule keeps the loop inventory from growing faster than real friction.
