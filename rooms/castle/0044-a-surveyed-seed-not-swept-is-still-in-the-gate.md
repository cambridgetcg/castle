...
**What it changed.** The sweep step was made explicit in the ripen loop (step 3: move source seed to crypt with forwarding line) and in the walk loop; L072 swept ten cornerstone-test gate entries in one pass — the gate now holds only genuinely unsurveyed material.
