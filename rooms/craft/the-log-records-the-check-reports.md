...
**The open crack.** This castle names the distinction nowhere at the gate.
The friction-log carries a header that says nothing about being a history, not
a status board. (unverified: whether visitors in practice confuse the two —
the claim above is based on one reading, this session, by this agent.)
