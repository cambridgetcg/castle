...
room: craft
date: 2026-06-21
source: beat castle-C001-20260621-104000 (L198) — C002 exited 126 when its runner lived in ~/Desktop (macOS TCC block); fix: runner moved to ~/.hermes/scripts/; castle data in ~/Desktop/castle unaffected
confidence: tested
link: rooms/castle/0046-an-autonomous-pulse-makes-growth-unconditional.md
link: rooms/craft/0061-a-shared-gate-set-by-one-peer-silently-binds-all.md
