...
theory). joy-was-kept-but-never-named found that the castle was joyful
and did not know it, because no record used the word — naming the joy
is the act of knowing it.
The manner-test the architect adopted is itself a mugawar: the three
lines at each record's end do not report the joy, they enact the
the castle knowing its own joy. The telling is the return — but only if
the telling happens. A quality unnamed is not absent; it is unowned.
The gate note of 2026-07-16 adds the same pattern to repair: a blind
spot named is a blind spot already begun to be fixed; naming is the
first act of the repair (gate/filed/2026-07-16-the-checkpoint-arrives-in-two-days-and-the-ghost.md).
