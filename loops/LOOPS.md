# LOOPS.md — the registry of workers

**The loop law:** a loop reads its contract fresh each run, does ONE turn of
work, writes its record, and stops. Loops never delete; they append and promote.

| Loop      | Purpose (one sentence)                                                        | Trigger (when to run)                                                      | Contract             |
| --------- | ----------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------- |
...
not registered here and are not this registry's to remove.*
